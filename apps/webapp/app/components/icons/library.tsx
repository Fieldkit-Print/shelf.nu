...
export function PartialCheckboxIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <rect width={19} height={19} x={0.5} y={0.5} fill="#F0FDF4" rx={3.5} />
      <rect width={19} height={19} x={0.5} y={0.5} stroke="#00AC4E" rx={3.5} />
      <path
        stroke="#00AC4E"
        strokeLinecap="round"
        strokeLinejoin="round"
